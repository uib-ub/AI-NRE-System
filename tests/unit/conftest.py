...
Provides fixtures used across multiple unit-test modules (config, file_io,
llm, prompt).  Infrastructure fixtures that apply to *all* tests (logging,
environment isolation, settings reset) remain in ``tests/conftest.py``.
"""
